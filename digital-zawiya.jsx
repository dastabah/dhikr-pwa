...
import { Home, BookOpen, Heart, Settings as SettingsIcon, ChevronDown, ChevronUp, Menu, X } from 'lucide-react';
...
const DigitalZawiyaApp = () => {
  ...
  const [defaultMode, setDefaultMode] = useLocalStorage('default_mode', 'quick');
...
export default DigitalZawiyaApp;
